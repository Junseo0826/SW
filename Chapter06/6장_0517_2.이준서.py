...
# 리스트를 문자열로 생성
text4 = str([1,2,3])    # '[', ']', ',' 모두 문자 취급
print('text4의 자료형 :', type(text4))
# 리스트 자체르 ㄹ문자열로 인식 하여 '[' 출력됨.
...
print('text1 내용의 모든 단어를 대문자로 변환 :', text2)
text3 = text2.lower()
print('text2 내용의 모든 단어를 소문자로 변환 :', text3)

# 문자열 정렬
print(text3.center(30, '*'))    # 30자 안에 text3를 중앙으로 정렬후 왼쪽과 오른쪽에 *
...
print("text3이 'i like'로 시작하는가?", text3.startswith('i like'))
print("text3이 'abc'로 시작하는가?", text3.endswith('abc'))
